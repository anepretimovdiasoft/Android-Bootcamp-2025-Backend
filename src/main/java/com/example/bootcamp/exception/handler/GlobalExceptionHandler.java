...
public class GlobalExceptionHandler {
    @ExceptionHandler(Volunteer_centerNotFoundException.class)
    public ResponseEntity<String> handleEmployeeNotFoundException(Volunteer_centerNotFoundException e) {
